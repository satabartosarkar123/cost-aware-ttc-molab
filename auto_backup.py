...
GDRIVE_FOLDER   = "gdrive:Molab_Backups/Cost-Aware-Test-Time"   # rclone remote path
BACKUP_INTERVAL = 3600          # seconds between backups (1 hour)
ZIP_PATH        = "/workspace/backup_cat.zip"

# Paste the FULL contents of your local rclone.conf here.
# It must include the [gdrive] section (and any other remotes you use).
# Example structure — replace everything between the triple-quotes:
RCLONE_CONF = """
[gdrive]
type = drive
...
scope = drive
token = {"access_token":"YOUR_ACCESS_TOKEN","token_type":"Bearer","refresh_token":"YOUR_REFRESH_TOKEN","expiry":"2099-01-01T00:00:00Z"}
team_drive =
"""
